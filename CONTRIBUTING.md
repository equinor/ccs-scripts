## Contributing to ccs-scripts

Please feel free to make contact if you have any suggestions, questions or bugs to report. It is possible to see the list of known tasks (bugs or new features) at [issues](https://github.com/equinor/ccs-scripts/issues).
